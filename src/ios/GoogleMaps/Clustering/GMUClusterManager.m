...
- (void) changeImageUrlForPOIItemAtIndex: (NSString*) poiItemId newImageUrl:(NSString*) imageUrl{
    ...
    if ([_renderer respondsToSelector:@selector(changeImageUrlForPOIItemAtIndex:newImageUrl:)]) {
        GMUDefaultClusterRenderer* clusterRenderer = (GMUDefaultClusterRenderer*) _renderer;
        [clusterRenderer changeImageUrlForPOIItemAtIndex:poiItemId newImageUrl:imageUrl];
    }
}
